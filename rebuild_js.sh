...
make -C src debug -j20 && cp ../build-native/usr/lib/julia/sys.ji . \
  && emcc -DJL_DISABLE_LIBUV -Isrc -I../src -I../src/support -Lusr/lib -ljulia-debug \
    -lLLVMSupport -lpcre2-8 -lgmp -lmpfr -ldSFMT $DIR/nsysimg/text.o $DIR/nsysimg/data.o ../ui/wasm-support.c \
    --no-heap-copy \
    ...
    --pre-js ../src/jsvm-emscripten/asyncify_setup.js --pre-js ../src/jsvm-emscripten/boxed.js \
    --js-library ../src/jsvm-emscripten/task.js --js-library ../src/jsvm-emscripten/jscall.js --emrun \
