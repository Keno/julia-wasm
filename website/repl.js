...
function input_eval(text) {
    ...
    add_to_terminal("<span class=\"color-scheme-prompt\">julia&gt;&nbsp;</span>"+indent_and_escape_html(text)+"<br />");
}
...
var Module = {
  ...
  print: (function() {
    return function(text) {
        add_to_terminal(escape_html(text) + '<br/>');
    };
  })(),
  ...
  setStatus: function(text) {
      add_to_terminal("<span class=\"color-scheme-message\">"+escape_html(text)+"</span><br /><br />");
  },
  totalDependencies: 0,
